...
<div class="container">
        ...
        <div class="col-6" style="line-height: 40px">
            <form action="" method="post" id="form-search" class="d-flex" style="margin-bottom: 0">
                ...
                <div class="col-8 d-inline-flex">
                    ...
                    <button class="btn btn-primary btn-submit-search" href="" type="submit" style="width: 120px">Tìm kiếm</button>
                </div>
            </form>
        </div>
    </div>
    <table class="table table-hover table-striped">
        ...
        <tr>
            ...
            <th scope="col" style="display: none">Mô tả</th>
        ...
        <c:if test="${not empty listProduct}">
            <c:forEach items="${listProduct}" var="item" varStatus="index">
                <tr>
                    ...
                    <td class="description" style="display: none">${item.description}</td>
